...
function MovieCard({ movie }: props) {
  ...
  return (
    <div onClick={() => router.push(`/movie/${movie.id}`)} className="flex-shrink-0 relative cursor-pointer transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg">
